...
$phome_db_server='127.0.0.1';	//数据库登陆地址
$phome_db_port='';	//端口，不填为按默认
$phome_db_username='root';	//数据库用户名
$phome_db_password='6399998';	//数据库密码
...
//后台安全设置
$do_loginauth='6399998';	//登录认证码,如果设置登录需要输入此认证码才能通过
$do_ecookiernd='96B9sA4w9fsLRzZ76zfZGEGZDXzcMy';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$phome_cookievarpre='ylzjy';		//前台cookie变量前缀
$phome_cookieadminvarpre='scwga';		//后台cookie变量前缀
$phome_cookieckrnd='32UnSNshQQbx9PcmMXsB5GSzUDYkbt';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
...
//------------e_public
$public_r=array('sitename'=>'百优卡-新闻资讯',
'newsurl'=>'/empireCMS/',
...
'keytog'=>2,
'keytime'=>30,
'keyrnd'=>'j7cVFuVHTZziEjpmvCRU7qdfmVfFLu',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/empireCMS/bucartrends/\">百优卡动态</a>&nbsp;|&nbsp;<a href=\"/empireCMS/dealguide/\">交易指南</a>&nbsp;|&nbsp;<a href=\"/empireCMS/fieldnews/\">行业新闻</a>&nbsp;|&nbsp;<a href=\"/empireCMS/carsguide/\">车辆导购</a>&nbsp;|&nbsp;<a href=\"/empireCMS/carscare/\">用车护车</a>&nbsp;|&nbsp;<a href=\"/empireCMS/recocars/\">推荐车源</a>&nbsp;|&nbsp;<a href=\"/empireCMS/hotnews/\">热门资讯排行</a>',
'plgroupid'=>0,
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
