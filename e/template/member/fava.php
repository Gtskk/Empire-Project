...
?>
<?php
$url="<a href=../../../>首页</a>&nbsp;>&nbsp;<a href=../cp/>控制面板</a>&nbsp;>&nbsp;收藏夹";
        ...
        <table width="100%" border="0" cellpadding="3" cellspacing="1" class="tableborder">
          <form name=favaform method=post action="../../enews/index.php" onsubmit="return confirm('确认要操作?');">
			...
			while($fr=$empire->fetch($sql))
			{
				...
				{continue;}
				$r=$empire->fetch1("select title,titleurl,groupid,filename,newspath,onclick,classid,id from {$dbtbpre}ecms_".$class_r[$fr[classid]][tbname]." where id='$fr[id]' and checked=1");
				//标题链接
