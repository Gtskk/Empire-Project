...
(*)</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>联系电话</td><td bgcolor='ffffff'><input name="call" type="text" id="call" value="<?=$ecmsfirstpost==1?"":htmlspecialchars(stripSlashes($addr[call]))?>">
