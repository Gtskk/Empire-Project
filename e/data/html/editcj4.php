...
</td></tr><tr><td bgcolor=ffffff>作者</td><td bgcolor=ffffff><input name="flashwriter" type="text" size=60 id="flashwriter" value="<?=$ecmsfirstpost==1?"":htmlspecialchars(stripSlashes($r[flashwriter]))?>">
</td></tr><tr><td bgcolor=ffffff>作者邮箱</td><td bgcolor=ffffff><input name="email" type="text" size=60 id="email" value="<?=$ecmsfirstpost==1?"":htmlspecialchars(stripSlashes($r[email]))?>">
