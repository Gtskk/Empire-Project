...
<body onLoad="initialize();ContextMenu.intializeContextMenu();" bgcolor="#FFCFAD">
	...
	<table border=0 cellspacing=0 cellpadding=0>
			<tr>
			<td id="pr58" class="file" onclick=""><a onclick=tourl(0,58) onmouseout=chft(this,0,58) onmouseover=chft(this,1,58) oncontextmenu=ShRM(this,0,58,'',1)>PHP技术</a></td>
		  </tr>
				<tr>
			<td id="pr60" class="file" onclick=""><a onclick=tourl(0,60) onmouseout=chft(this,0,60) onmouseover=chft(this,1,60) oncontextmenu=ShRM(this,0,60,'',1)>JSP技术</a></td>
		  </tr>
				<tr>
			<td id="pr61" class="file" onclick=""><a onclick=tourl(0,61) onmouseout=chft(this,0,61) onmouseover=chft(this,1,61) oncontextmenu=ShRM(this,0,61,'',1)>ASP技术</a></td>
		  </tr>
				<tr>
			<td id="pr62" class="file" onclick=""><a onclick=tourl(0,62) onmouseout=chft(this,0,62) onmouseover=chft(this,1,62) oncontextmenu=ShRM(this,0,62,'',1)>gts手册</a></td>
		  </tr>
			</table>
	</body>
</html>
